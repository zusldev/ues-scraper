    ...
    for event in events:
        ...
        lines.extend(
            [
                ...
                "TRIGGER:-PT24H",
                "ACTION:DISPLAY",
                f"DESCRIPTION:Entrega en 24h: {_ics_escape(event.title)}",
                "END:VALARM",
                "BEGIN:VALARM",
                "TRIGGER:-PT6H",
                "ACTION:DISPLAY",
                f"DESCRIPTION:Entrega en 6h: {_ics_escape(event.title)}",
                "END:VALARM",
                "BEGIN:VALARM",
                "TRIGGER:-PT1H",
                "ACTION:DISPLAY",
                f"DESCRIPTION:Entrega en 1h: {_ics_escape(event.title)}",
                "END:VALARM",
                "END:VEVENT",
            ]
        )
